...
<ProjectImagesBlock
    ...
    direction={"row"}
    caption={
        "This is where users click through different time frames to gain insights on their cortisol levels that were gathered through the mouse."
    }
    width={8}
    maxHeight={"400px"}
>
...
<ProjectImagesBlock
    ...
    direction={"row"}
    caption={
        "Autogenerated trends can assist the user in gaining insights into their stress levels to help them find unhelpful patterns that lead to high stress. They can also hover over the graphs for detailed information in word form rather than looking at the graph."
    }
    width={8}
    maxHeight={"400px"}
>
